function showActiveStep()
{
    ...
    else if ($('#step2').is(':visible'))
    {
        ...
        (
            {
                src: 'public/assets/images/side-img2.png',
            }
        )
    }
    else if ($('#step3').is(':visible'))
    {
        ...
        (
            {
                src: 'public/assets/images/side-img3.png',
            }
        )
    }
    else
    {
        ...
        (
            {
                src: 'public/assets/images/side-img4.png',
            }
        )
    }
}
    ...
    // check last step
     $("#sub").on('click' , function()
     {
        formvalidate(4);
          ...
          {
              $("#sub").html("<img src='public/assets/images/loading.gif'>");
