...
const StepperLinearWithValidation = () => {
  ...
  const handleReset = () => {
    ...
    accountReset({ email: '', fullName: '', password: '', 'confirm-password': '' })
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <TextField
                        ...
                        error={Boolean(accountErrors.fullName)}
                        aria-describedby='stepper-linear-account-fullName'
                      />
                    )}
                  />
                  {accountErrors.fullName && (
                    <FormHelperText sx={{ color: 'error.main' }} id='stepper-linear-account-fullName'>
