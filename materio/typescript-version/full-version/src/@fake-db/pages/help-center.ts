      ...
      subCategories: [
        {
          ...
          articles: [
            {
              slug: 'changing-your-fullName',
              title: 'Changing your fullName?',
              content:
                "<p>You can change your fullName to another fullName that is not currently in use. If the fullName you want is not available, consider other names or unique variations. Using a number, hyphen, or an alternative spelling might help you find a similar fullName that's still available.</p> <p>After changing your fullName, your old fullName becomes available for anyone else to claim. Most references to your repositories under the old fullName automatically change to the new fullName. However, some links to your profile won't automatically redirect.</p><p>You can change your fullName to another fullName that is not currently in use. If the fullName you want is not available, consider other names or unique variations. Using a number, hyphen, or an alternative spelling might help you find a similar fullName that's still available.</p> <p>After changing your fullName, your old fullName becomes available for anyone else to claim. Most references to your repositories under the old fullName automatically change to the new fullName. However, some links to your profile won't automatically redirect.</p>"
            },
            {
        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content:
                "<p>Two-factor authentication (2FA) is an extra layer of security used when logging into websites or apps. With 2FA, you have to log in with your fullName and password and provide another form of authentication that only you know or have access to.</p> <p>For our app, the second form of authentication is a code that's generated by an application on your mobile device or sent as a text message (SMS). After you enable 2FA, App generates an authentication code any time someone attempts to sign into your account. The only way someone can sign into your account is if they know both your password and have access to the authentication code on your phone.</p><p>Two-factor authentication (2FA) is an extra layer of security used when logging into websites or apps. With 2FA, you have to log in with your fullName and password and provide another form of authentication that only you know or have access to.</p> <p>For our app, the second form of authentication is a code that's generated by an application on your mobile device or sent as a text message (SMS). After you enable 2FA, App generates an authentication code any time someone attempts to sign into your account. The only way someone can sign into your account is if they know both your password and have access to the authentication code on your phone.</p>"
            },
            {
      ...
      subCategories: [
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content:
                '<p>To help keep your account secure, we recommend the following best practices:</p><ul><li>Use a strong password that you don’t reuse on other websites.</li><li>Use two-factor authentication.</li><li>Require email and phone number to request a reset password link or code.</li><li>Be cautious of suspicious links and always make sure you’re on our website before you enter your login information.</li><li>Never give your fullName and password out to third parties, especially those promising to get you followers, make you money, or verify you.</li></ul><p>To help keep your account secure, we recommend the following best practices:</p><ul><li>Use a strong password that you don’t reuse on other websites.</li><li>Use two-factor authentication.</li><li>Require email and phone number to request a reset password link or code.</li><li>Be cautious of suspicious links and always make sure you’re on our website before you enter your login information.</li><li>Never give your fullName and password out to third parties, especially those promising to get you followers, make you money, or verify you.</li></ul>'
            },
            {
              slug: 'help-with-my-hacked-account',
              title: 'Help with my hacked account',
              content:
                "<p>If you think you've been hacked and you're unable to log in with your fullName and password, please take the following two steps:</p><ol><li><p>Request a password reset</p> <p>Reset your password by requesting an email from the password reset form. Try entering both your fullName and email address, and be sure to check for the reset email at the address associated with your account.</p></li><li><p>Contact Support if you still require assistance</p><p>If you still can't log in, contact us by submitting a Support Request. Be sure to use the email address you associated with the hacked account; we'll then send additional information and instructions to that email address. When submitting your support request please Include both your fullName and the date you last had access to your account.</p></li></ol><p>If you think you've been hacked and you're unable to log in with your fullName and password, please take the following two steps:</p><ol><li><p>Request a password reset</p> <p>Reset your password by requesting an email from the password reset form. Try entering both your fullName and email address, and be sure to check for the reset email at the address associated with your account.</p></li><li><p>Contact Support if you still require assistance</p><p>If you still can't log in, contact us by submitting a Support Request. Be sure to use the email address you associated with the hacked account; we'll then send additional information and instructions to that email address. When submitting your support request please Include both your fullName and the date you last had access to your account.</p></li></ol>"
            }
          ]
        },
        {
      ...
      subCategories: [
        {
          ...
          articles: [
            ...
            {
              slug: 'what-is-fullName-squatting-policy',
              title: 'What is fullName squatting policy?',
              content:
                "<p>fullName squatting is prohibited by the Rules.</p><p>Please note that if an account has had no updates, no profile image, and there is no intent to mislead, it typically means there's no name-squatting or impersonation. Note that we will not release squatted fullNames except in cases of trademark infringement. If your report involves trademark infringement, please consult those policies for instructions for reporting these accounts.</p><p>Attempts to sell, buy, or solicit other forms of payment in exchange for fullNames are also violations and may result in permanent account suspension.</p><p>fullName squatting is prohibited by the Rules.</p><p>Please note that if an account has had no updates, no profile image, and there is no intent to mislead, it typically means there's no name-squatting or impersonation. Note that we will not release squatted fullNames except in cases of trademark infringement. If your report involves trademark infringement, please consult those policies for instructions for reporting these accounts.</p><p>Attempts to sell, buy, or solicit other forms of payment in exchange for fullNames are also violations and may result in permanent account suspension.</p>"
            },
            {
